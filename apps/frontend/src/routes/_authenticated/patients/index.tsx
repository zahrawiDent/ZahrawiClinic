                    ...
                    <table class="min-w-full divide-y divide-[var(--color-border-primary)]">
                      ...
                      <tbody class="bg-[var(--color-bg-elevated)] divide-y divide-[var(--color-border-primary)]">
                        <For
                          ...
                          fallback={
                            <tr>
                              <td colspan="6" class="px-6 py-4 text-center text-[var(--color-text-tertiary)]">
                                No patients found
                              </td>
                            </tr>
                          }
                              ...
                              >
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                  <span
                                    ...
                                    classList={{
                                      'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200': patient.status === 'active',
                                      'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300': patient.status === 'inactive',
                                      'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200': patient.status === 'archived',
                                    }}
                                  >
